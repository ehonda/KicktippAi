...
- **Refresh sources:** ADR-0074/0077/0078, [ADR-0079](../../../../plans/bundesliga-2026-27/decisions/0079-pin-roster-refresh-endpoints-and-close-c2-validation.md), and [ADR-0081](../../../../plans/bundesliga-2026-27/decisions/0081-close-club-elo-html-publication-and-selection-seams.md) govern dormant P1-04/P1-05. Club Elo's future candidate is descriptor-selected official HTML (`club-elo/source.html`), with historical CSV evidence only; ADR-0081 closes shared selection, receipt completion and source-backed publication while preserving CSV fractional Elo compatibility. P1-05 is HTML-independent and dcaribou-sidecar-gated: until the exact linked sidecar exists, it is `MetadataUnavailable`, requests no artifact, and retains seed/LKG; the current DuckDB is rejection-only evidence. Source flags remain false: no source resolution, acquisition, persistence, artifact, issue or API behavior occurs.
