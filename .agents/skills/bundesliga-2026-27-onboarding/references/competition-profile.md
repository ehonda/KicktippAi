...
- **Context:** standings, community rules, recent/home/away history, head-to-head, paired roster/Club Elo docs, aggregate `team-rosters`, and KPIs `club-elo-rankings`/`team-squad-summary`; home/away/head-to-head enabled, knockout/transfers prohibited. Apply ADR-0074/0077/0078 source-provenance contracts.
- **Refresh sources:** ADR-0074/0077/0078 govern dormant P1-04/P1-05. Club Elo's future candidate is descriptor-selected official HTML (`club-elo/source.html`), with historical CSV evidence only; roster remains source-independent from HTML and current DuckDB is rejection-only evidence. Source flags remain false: no source resolution, acquisition, persistence, artifact, issue or API behavior occurs.
