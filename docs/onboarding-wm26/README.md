...
Before running these shortcuts, make sure the required `lineup-*` context documents and the aggregate `lineups` KPI document have been generated, uploaded, or copied with `$wm26-lineups`.
