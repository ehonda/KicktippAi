...
| [P0-19 arena production copy](tasks/p0-19-arena-production-copy-workflow-triad.md) | Blocked/nondeployable: add the manual-only `ehonda-ai-arena` production-copy triad after owner selection, credential, reference-runtime, and compatibility gates | P0-06, P0-17, P0-18, P0-24, P0-19 pes-squad production reference |
