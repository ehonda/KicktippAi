...
- The first exact-head CI run, [32530506340](https://github.com/ehonda/KicktippAi/actions/runs/32530506340), exposed one deterministic integration-harness omission: the new `ICommunityKicktippCredentialLoader` was not registered by `OrchestratorIntegrationTestFactories`. All other test jobs passed; this was not a credential, Docker, worktree, approval, or hosted-runner failure.
- Commit `316c34c6acc43ed32ac817b1198549876f26ffe0` added that missing mock registration. The focused Release integration suite passed `4/4`, and the repaired exact-head CI run [32531187250](https://github.com/ehonda/KicktippAi/actions/runs/32531187250) passed Build, all eight test projects, merged coverage, and Pages.
