...
- [ ] Add an interface-backed rating source beside the FIFA ranking source so network parsing can be fixture-tested.
...
- [ ] Publish atomically to the explicit 2026/27 partition and preserve the last complete snapshot on any partial failure.
