...
- ADR-0044 preserves this exact 401-document catalog: the full-season Kicktipp candidate must contain its exact 362-document subset (standings, rules, 54 canonical selected histories, and 306 exact-matchday H2Hs) before the strict inventory can pass. No expected-set relaxation is permitted.
