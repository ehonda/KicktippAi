...
- [ ] Add the Bundesliga profile in dependency order: Kicktipp, Bundesliga history played-date reconstruction, Club Elo, and rosters; home/away/head-to-head enabled; no FIFA, WM26 date map, national lineups, knockout behavior, or transfers.
