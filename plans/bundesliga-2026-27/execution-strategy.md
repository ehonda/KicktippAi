...
| Launch roster remediation | P0-25 active in parallel with P0-23 | v2 is integrated and green; the pinned artifact meets 464/464/450 coverage; arena publication and one authorized Luna/none trace round prove enrichment and one final derived subtotal row per team |
...
| Launch roster publication | ADR-0050 v2 adds one final known-value subtotal row per team; explicit pinned-artifact publication must pass 464 age / 464 position / 450 valuation floors, then no-DuckDB collection preserves enriched last-known-good; recurring automation stays P1-05 |
