...
{
    [Test]
    [Arguments("openligadb-bl2-2025.json", OpenLigaDbHistorySnapshotKind.SecondBundesliga, 306)]
    [Arguments("openligadb-rel-2025.json", OpenLigaDbHistorySnapshotKind.Relegation, 2)]
    [Arguments("openligadb-dfb-2025.json", OpenLigaDbHistorySnapshotKind.DfbPokal, 63)]
