...
internal sealed record PreparedExperimentAnalysisRun(
    ...
    [property: JsonPropertyName("promptSource")] string? PromptSource,
    [property: JsonPropertyName("langfusePromptName")] string? LangfusePromptName,
    [property: JsonPropertyName("langfusePromptLabel")] string? LangfusePromptLabel,
    [property: JsonPropertyName("langfusePromptVersion")] int? LangfusePromptVersion,
    ...
    [property: JsonPropertyName("batchStrategy")] string? BatchStrategy,
    [property: JsonPropertyName("batchSize")] int? BatchSize,
    [property: JsonPropertyName("batchCount")] int? BatchCount,
